...
function generateAccessToken(user) {
    ...
    const accessToken = jwt.sign({ user: user }, process.env.ACCESS_TOKEN_SECRET, { expiresIn: '7d' }); //! Might need to implement refresh tokens in the future rather than simply hardcoded week long expiration dates.
    return accessToken;
}
